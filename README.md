...
- **RGPD / cookies** : bandeau de consentement (Accepter / Refuser) ; la carte OpenStreetMap ne se charge qu'**après accord**, le choix est mémorisé et modifiable (lien « Cookies » en pied de page). Mentions légales renseignées avec les informations du site officiel (éditeur La Carline, Route du Sauze, 05160 Savines-le-Lac).
